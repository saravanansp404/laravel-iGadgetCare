              ...
              <div class="card-body">
                ...
                @foreach($users as $users)
                  <div class="col-sm-2">
                      ...
                      <?php   $image =  str_replace('[', '', $users->images);
               ...
               @foreach($images as $images1)
                  ...
                  <a href="../images/<?php echo $images1;?>" data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                      <img src="../images/<?php  echo $images1;?>" class="img-fluid mb-2" alt="white sample"/>
                    </a>

              @endforeach
              <a href="imagedelete/{{ $users->id}} " class="btn btn-danger">Delate</a>
              <button id="{{ $users->id}}" class="btn btn-success"  data-toggle="modal"  
data-target="#exampleModal" onClick="reply_click(this.id)">Edit</button>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="">Edcloud</a>.</strong> All rights reserved.
  </footer>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <?php echo $imgid=5;
         ...
         ?>
        <form action="{{route('posts.update',$imgid)}}" method="POST" enctype="multipart/form-data"> 
        @csrf
        @method('PUT')
...
<script type="text/javascript">
  function reply_click(clicked_id)
  {
      ...
      document.getElementById("modal_body").innerHTML = id;
  }
</script>